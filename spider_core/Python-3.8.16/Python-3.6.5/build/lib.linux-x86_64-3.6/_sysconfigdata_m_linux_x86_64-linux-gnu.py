...
build_time_vars = {'ABIFLAGS': 'm',
 ...
 'BLDSHARED': 'gcc -pthread -shared -fprofile-generate',
 'BUILDEXE': '',
 'BUILDPYTHON': 'python',
 ...
 'COREPYTHONPATH': ':',
 'COVERAGE_INFO': '/opt/spider_project/spider_core/Python-3.8.16/Python-3.6.5/coverage.info',
 'COVERAGE_REPORT': '/opt/spider_project/spider_core/Python-3.8.16/Python-3.6.5/lcov-report',
 ...
 'LDLIBRARYDIR': '',
 'LDSHARED': 'gcc -pthread -shared -fprofile-generate',
 'LDVERSION': '3.6m',
 'LIBC': '',
 ...
 'PY_CORE_CFLAGS': '-Wno-unused-result -Wsign-compare -DNDEBUG -g -fwrapv -O3 '
                   ...
                   '-Wno-missing-field-initializers -fprofile-generate -I. '
                   '-I./Include  -DPy_BUILD_CORE',
 'PY_CPPFLAGS': '-I. -I./Include',
 'PY_FORMAT_SIZE_T': '"z"',
 'PY_LDFLAGS': '-fprofile-generate',
 'Py_DEBUG': 0,
 'Py_ENABLE_SHARED': 0,
 'Py_HASH_ALGORITHM': 0,
 ...
 'abs_builddir': '/opt/spider_project/spider_core/Python-3.8.16/Python-3.6.5',
 'abs_srcdir': '/opt/spider_project/spider_core/Python-3.8.16/Python-3.6.5',
